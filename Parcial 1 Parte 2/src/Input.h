...
int utn_getTextoPrueba(char* mensaje, char* mensajeError, int reintentos,  int longitud, char* pResultado);
int utn_getCaracter(char* mensaje,char* mensajeError,char minimo,char maximo,int reintentos,char* pResultado);
